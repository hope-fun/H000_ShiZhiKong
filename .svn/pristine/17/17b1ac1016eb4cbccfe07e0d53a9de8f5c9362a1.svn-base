                    ...
                    if (xhr.readyState === 4) {
                        ...
                        if ((xhr.status >= 200 && xhr.status < 300) || xhr.status === 0&&protocol=='file:') {
                            if (mime === 'application/json' && !(/^\s*$/.test(xhr.responseText))) {
                                ...
                                // Commented by Feng.lu, since most of javascript is based on the response script
                                // $.parseJS(result);
                            }
                            else
                                result = xhr.responseText;
                            ...
                            if (error)
                                ...
                                // Added by Feng.lu, since most of javascript is based on the response script
                                if(mime=="text/html"){
                                    $.parseJS(result);
                                }
