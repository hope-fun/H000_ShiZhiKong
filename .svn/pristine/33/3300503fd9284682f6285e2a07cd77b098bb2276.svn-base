...
- (NSObject<HTTPResponse> *)httpResponseForMethod:(NSString *)method URI:(NSString *)path
{
	...
	NSLog(@"Path is %@  AND filePath is %@",path,filePath);
	BOOL isDir = NO;
...
#ifdef KPYX_QAOne
        NSString *downpath = [NSString stringWithFormat:@"http://10.20.70.24:8888/kpyx-logical-service%@",path];
        
#endif
#ifdef KPYX_QATwo
        NSString *downpath = [NSString stringWithFormat:@"http://cardgame.artist-mobile.com:8080/kpyx-logical-service%@",path];
#endif
#ifdef KPYX_QAThree
        NSString *downpath = [NSString stringWithFormat:@"http://cardtest.artist-mobile.com:8080/kpyx-logical-service%@",path];
#endif
   
        DownloadImageResponse *fileResponse = [[DownloadImageResponse alloc] initWithFilePath:downpath forConnection:self];
        //           DownloadImageResponse *fileResponse = [[DownloadImageResponse alloc] initWithFilePath:@"http://d.hiphotos.baidu.com/album/w%3D2048/sign=6b070cbb023b5bb5bed727fe02ebd539/7dd98d1001e93901620c802e7aec54e736d19697.jpg" forConnection:self];
//            return fileResponse;
        return  [[HTTPRedirectResponse alloc] initWithPath:downpath];
    }
