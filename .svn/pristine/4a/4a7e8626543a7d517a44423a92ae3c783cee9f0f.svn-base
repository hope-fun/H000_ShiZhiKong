...
var step5Fun = null;
var step6Fun = null;
var stepWorld1Fun = null;
var stepWorld2Fun = null;
var stepWorld3Fun = null;
var stepWorld4Fun = null;
var stepWorld5Fun = null;
var stepCoco1 = null;
var mainCardStep1=null;
var mainCardStep2=null;
var mainCardStep3=null;


function css3AnimationFactory() {

	// 获得玩家主卡
	this.getPlayerMainCardAnimation = function(selector) {
		var animationHolder = $(selector+' .animationHolder');
		var lightRay = $(selector + ' .animationHolder .contentLightRayOper');
		var cocoTips = $(selector + ' cg200101-ani-coco02');
		var getCard =  $(selector + ' .animationHolder .contentGet');
		...
		var paddingTop02 = window.screen.availHeight * 0.72;
		
		var upBlack = $(selector + ' .cg200101-ani-coco .upBlack');
		var downBlack = $(selector + ' .cg200101-ani-coco .downBlack');
		var coCoPic = $(selector + ' .cg200101-ani-coco .cocoPic');
		var conversationInfo = $(selector + ' .cg200101-ani-coco .conversation-bg');
		var coCoIntroduce = $(selector + ' .cg200101-ani-coco .conversation-bg .conversation-info .coco-introduce');
		var arrowBeat = $(selector + ' .cg200101-ani-coco .conversation-bg .conversation-info .arrow-beat');
		
		$(selector + " .cg200101-ani-coco").css("height",maxHeight + "px");
		$(selector + " .cg200101-ani-coco").css("display", "block");
		...
		function init() {
			...
			var maxHeight = 720 / window.screen.availWidth* window.screen.availHeight*1.1;
			$(selector + " .cg200101-ani-world").css("height", 	maxHeight + "px");
			$(selector + " .cg200101-ani-world").css("display", "block");
			
			$(selector + " .cg200101-ani-coco").css("height",maxHeight + "px");
			$(selector + " .cg200101-ani-coco").css("display", "block");
			
			coCoPic.css('display', 'block');
			coCoPic.css('top',maxHeight*0.1 + "px" );
			upBlack.css('display', 'block');
			upBlack.css('top', '0px');
			downBlack.css('display', 'block');
			downBlack.css('top', maxHeight*0.9 + "px");
			downBlack.addClass("downBlack_ani");

			conversationInfo.css('display', 'block');
			conversationInfo.css('top', maxHeight * 0.6 + "px");
	...
	this.showMainCard = function(selector){
		$(selector + " .cg200101-ani-world").css("display", "none");
		$(selector + " .cg200101-ani-coco").css("display", "none");
		var animationHolder = $(selector+' .animationHolder');
		var lightRay = $(selector + ' .animationHolder .contentLightRayOper');
		var cocoTips = $(selector + ' cg200101-ani-coco02');
		var getCard =  $(selector + ' .animationHolder .contentGet');
		...
		var maxHeight = 720 / window.screen.availWidth
				* window.screen.availHeight*1.1;
		var paddingTop02 = window.screen.availHeight * 0.72;
		animationHolder.css("display", "block");
		var upBlack = $(selector + ' .cg200101-ani-coco .upBlack');
		var downBlack = $(selector + ' .cg200101-ani-coco .downBlack');
		var coCoPic = $(selector + ' .cg200101-ani-coco .cocoPic');
		var conversationInfo = $(selector + ' .cg200101-ani-coco .conversation-bg');
		...
		function init(){
			...
			mainCardStep1 = setTimeout(step1, 500);
		}
		function step1() {			
			lightRay.css("display", "block");
			lightRay.addClass('contentLightRay');
			mainCardStep2 = setTimeout(step2, 1800);

		}
		function step2(){
			lightRay.css("display", "none");
			getCard.css("display", "block");
			getCard.css("left", imgLeft);
			mainCardStep3 = setTimeout(step3, 1800);
		}
		function step3() {
	...
	this.worldTips = worldTipsFunction;
	function worldTipsFunction(selector) {
		JSInterface.clickTone(240);
		JSInterface.clickTone(141);
		
		var world01 = $(selector + ' .cg200101-ani-world .ani-des-world01');
		var world02 = $(selector + ' .cg200101-ani-world .ani-des-world02');
		var world03 = $(selector + ' .cg200101-ani-world .ani-des-world03');
		var world04 = $(selector + ' .cg200101-ani-world .ani-des-world04');
		var skipCoco = $(selector + ' .cg200101-ani-world .ani-skip-coco');
		var maxWidth = 720;
		var maxHeight = 720 / window.screen.availWidth
				* window.screen.availHeight*1.1;
		var paddingTop02 = window.screen.availHeight * 0.4;

		var wpic01 = maxWidth * 0.615;
		var wpicMiddle01 = (maxWidth - wpic01) / 2;

		var wpic02 = maxWidth * 0.75;
		var wpicMiddle02 = (maxWidth - wpic02) / 2;

		var wpic03 = maxWidth * 0.893;
		var wpicMiddle03 = (maxWidth - wpic03) / 2;

		var wpic04 = maxWidth * 0.694;
		var wpicMiddle04 = (maxWidth - wpic04) / 2;

		var paddingTop = window.screen.availHeight;
		var paddingTop04 = window.screen.availHeight-45;
		...
		function initWorld() {
			$(selector + " .cg200101-ani-world").css("height", 	maxHeight + "px");
			$(selector + " .cg200101-ani-world").css("display", "block");
			$(selector + " .cg200101-ani-world").addClass("cg200101-ani-world-animation");
			stepWorld1Fun = setTimeout(stepWorld1, 500);
		}

		function stepWorld1() {			
			world01.css('display', 'block');
			skipCoco.css('display', 'block');
			skipCoco.css('top', window.screen.availHeight*2.1 + "px");
			$(".ani-skip-coco").attr('onclick', "skipToCoco()");
			world01.css('top', paddingTop + "px");
			world01.css('left', wpicMiddle01 + "px");
			world01.addClass("ani-des-world");
			stepWorld2Fun = setTimeout(stepWorld2, 4800);
		}

		function stepWorld2() {
			world01.css('display', 'none');
			skipCoco.css('display', 'block');
			skipCoco.css('top', window.screen.availHeight*2.1 + "px");
			$(".ani-skip-coco").attr('onclick', "skipToCoco()");
			world02.css('display', 'block');
			world02.css('top', paddingTop + "px");
			world02.css('left', wpicMiddle02 + "px");
			world02.addClass("ani-des-world");
			stepWorld3Fun = setTimeout(stepWorld3, 4800);
		}
		function stepWorld3() {
			world02.css('display', 'none');
			world03.css('display', 'block');
			skipCoco.css('display', 'block');
			skipCoco.css('top', window.screen.availHeight*2.1+ "px");
			$(".ani-skip-coco").attr('onclick', "skipToCoco()");
			world03.css('top', paddingTop04 + "px");
			world03.css('left', wpicMiddle03 + "px");
			world03.addClass("ani-des-world");
			stepWorld4Fun = setTimeout(stepWorld4, 4800);
		}
		function stepWorld4() {
			world03.css('display', 'none');
			world04.css('display', 'block');
			skipCoco.css('display', 'block');
			skipCoco.css('top', window.screen.availHeight*2.1+ "px");
			$(".ani-skip-coco").attr('onclick', "skipToCoco()");
			world04.css('top', paddingTop04 + "px");
			world04.css('left', wpicMiddle04 + "px");
			world04.addClass("ani-des-world");
			stepWorld5Fun = setTimeout(stepWorld5, 4800);
		}
		function stepWorld5(){
			cocoTipsFunction(selector);
		}

	}

	this.cocoTips = cocoTipsFunction;
	function cocoTipsFunction(selector) {
		JSInterface.clickTone(241);
		JSInterface.clickTone(142);
		...
		if ($('.cg200101-ani-world').hasClass('cg200101-ani-world-animation')) {
			$('.cg200101-ani-world').removeClass('cg200101-ani-world-animation');
		}
		$(".ani-des-world01").css("display", "none");
		$(".ani-des-world02").css("display", "none");
		$(".ani-des-world03").css("display", "none");
		$(".ani-des-world04").css("display", "none");
		$(".ani-skip-coco").css("display", "none");
		...
		function initCoco() {
			$(selector + " .cg200101-ani-coco").css("height",maxHeight + "px");
			$(selector + " .cg200101-ani-coco").css("display", "block");
			stepCoco1 = setTimeout(stepCoco1, 300);
		}
		function stepCoco1() {
			coCoPic.css('display', 'block');
			coCoPic.css('top',maxHeight*0.1 + "px" );
			...
			upBlack.addClass("upBlack_ani");
			coCoPic.addClass("cocoPic_ani");
			conversationInfo.css('display', 'block');
			conversationInfo.css('top', maxHeight * 0.6 + "px");
	...
	this.cg200101Animation = function(selector) {
		...
		JSInterface.clickTone(140);
		var queenPic = $(selector + ' .cg200101-ani-index .ani-xieci-pic');
		var desPic01 = $(selector + ' .cg200101-ani-index .ani-des-pic01');
		var desPic02 = $(selector + ' .cg200101-ani-index .ani-des-pic02');
		var desPic03 = $(selector + ' .cg200101-ani-index .ani-des-pic03');
		var desPic04 = $(selector + ' .cg200101-ani-index .ani-des-pic04');
		var desPic05 = $(selector + ' .cg200101-ani-index .ani-des-pic05');
		var smoke = $(selector + ' .cg200101-ani-index .ani-smoke');
		var skipWorld = $(selector + ' .cg200101-ani-index .ani-skip-world');
		...
		var paddingTop = window.screen.availHeight*0.6;
		...
		var picMiddle05 = (maxWidth - pic05) / 2;
		 ...
		 var topHeight04 = window.screen.availHeight+35;
		 var topHeight05 = window.screen.availHeight+25;
		 
		// 设置展示最大高度
		$(selector + ' .cg200101-ani-index').css("height", maxHeight + "px");
		init();
		function init() {
			
			step1Fun = setTimeout(step1, 1500);
		}
		...
		function step1() {
			...
			skipWorld.css('display', 'block');
			skipWorld.css('top', window.screen.availHeight*2.1+ "px");
			$(".ani-skip-world").attr('onclick', "skipToWorld()");
			desPic01.addClass("ani-des");
			step2Fun = setTimeout(step2, 4800);
		...
		function step2() {
			...
			step3Fun = setTimeout(step3, 4800);
		}
		function step3() {
			...
			step4Fun = setTimeout(step4, 4800);
		}
		function step4() {
			...
			skipWorld.css('top', window.screen.availHeight*2.1+ "px");
			$(".ani-skip-world").attr('onclick', "skipToWorld()");
			desPic04.css('top', topHeight04 + "px");
			desPic04.css('left', picMiddle04 + "px");
			smoke.css('display', 'block');
			queenPic.css('display', 'block');
			desPic04.addClass("ani-des");
			step5Fun = setTimeout(step5, 4800);
		}
		function step5() {
			...
			smoke.css('display', 'block');
			queenPic.css('display', 'block');
			desPic05.css('top', topHeight05 + "px");
			desPic05.css('left', picMiddle05 + "px");
			desPic05.addClass("ani-des");
			step6Fun = setTimeout(step6, 4800);

		}
		function step6(){
			worldTipsFunction(selector)
		}
	...
	// 战斗动画
	this.fightAnimation = function(selector, fightPro, imgSrcPrefix,
			fightResult) {
		...
		function step1() {
			...
			container.find(".downPart").find(".cardHolder").css3Animate({
								bottom : "8%",
								time : "300ms",
								timingFunction : "ease",
								callback : function() {
									container.find(".downPart").find(".nameHolder").css3Animate({
														left : "1px",
														time : "300ms",
														timingFunction : "ease",
														callback : function() {
															alert
															container.find(".downPart").find(".attackPower").css3Animate({
																				left : "1px",
																				time : "300ms",
																				timingFunction : "ease"
																			});
			...
			container.find(".upPart").find(".cardHolder").css3Animate({
								rotateX : "180deg",
								time : "0ms",
								noneedorigin : true,
								callback : function() {
									container.find(".upPart").find(".cardHolder").css3Animate({
														...
														noneedorigin : true,
														callback : function() {
															container.find(".upPart").find(".nameHolder").css3Animate({
																				right : "1px",
																				time : "300ms",
																				timingFunction : "ease",
																				callback : function() {
																					container.find(".upPart").find(".defensePower").css3Animate({
																										right : "1px",
																										time : "300ms",
																										timingFunction : "ease",
																										callback : step2
