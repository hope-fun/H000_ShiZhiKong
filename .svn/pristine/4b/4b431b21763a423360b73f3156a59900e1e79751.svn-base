...
<div class="content">
	...
	<div class="continueButton">
			<img class="clickTone1" src='<p:localurl value="/resources/images/buttons/tiaozhanxiageBOSS-green-z.png"/>'  onclick="location.href='<p:fullurl value="/cg1801/cg180103/index/${raidType}/"/>';event.preventDefault();"/>
	</div>
	<div class="continueButton">
			<img class="clickTone1" src='<p:localurl value="/resources/images/buttons/chongxintiaozhan-blue-z.png"/>' <c:if test="${empty isCanRechallenge}"> onclick="location.href='<p:fullurl value="/cg1801/cg180103/reChallenge/${raidId}"/>';event.preventDefault();" </c:if> <c:if test="${not empty isCanRechallenge}"> class="confirm_popup" message="<spring:message code="label.cg1802.popmessage"></spring:message>"</c:if>/>
	</div>
	...
	<div class="continueButton">
			<img class="clickTone1" src='<p:localurl value="/resources/images/buttons/chongxintiaozhan-blue-z.png"/>' <c:if test="${empty isCanRechallenge}"> onclick="location.href='<p:fullurl value="/cg1801/cg180102/index/"/>';event.preventDefault();" </c:if> <c:if test="${not empty isCanRechallenge}"> class="confirm_popup" message="<spring:message code="label.cg1802.popmessage"></spring:message>"</c:if>/>
	</div>
	</c:if>
</div>