...
<div class="content">
	<div class="main-title menu-medium">
		<span><spring:message code="label.cg180302.title"></spring:message></span>
	</div>
			...
			<div class="border-content-noleft">
				<div class="raid-section">
					<div class="raid-type-name fc-normal-03-m">
						<div class="raid-type">
							<spring:message code="label.cg180203.card_raid_type_a"></spring:message>
						</div>
					...
					<div>
						...
						<div class="raid-btn-action">
							<img
								...
								href="<p:fullurl value='/cg1803/cg180303/index/A' />" />
						</div>
			...
			<div class="borderPanel padding-top-style10">
				...
				<div class="border-content-noleft">
					<div class="raid-section">
						<div class="raid-type-name fc-normal-03-m">
							<div class="raid-type">
								<spring:message code="label.cg180203.card_raid_type_b"></spring:message>
							</div>
							<div class="raid-require-level">
								<span><img class="arrow-img"
						...
						<div>
							...
							<div class="raid-btn-action">
								<img
									...
									href="<p:fullurl value='/cg1803/cg180303/index/B' />" />
							</div>
							<div class="raid-clear-count clear-count">
								<spring:message code="label.cg180202.clear_count"></spring:message>
								${clearCountB}
			...
			<div class="borderPanel padding-top-style10">
				...
				<div class="border-content-noleft">
					<div class="raid-section">
						<div class="raid-type-name fc-normal-03-m">
							<div class="raid-type">
								<spring:message code="label.cg180203.card_raid_type_c"></spring:message>
							</div>
							<div class="raid-require-level">
								<span><img class="arrow-img"
									src="<p:localurl value='/resources/images/Arrow02.png' />" /></span>
						...
						<div>
							...
							<div class="raid-btn-action">
								<img
									...
									href="<p:fullurl value='/cg1803/cg180303/index/C' />" />
							</div>
							<div class="raid-clear-count clear-count">
								<spring:message code="label.cg180202.clear_count"></spring:message>
								${clearCountC}
			...
			<div class="borderPanel padding-top-style10">
				...
				<div class="border-content-noleft">
					<div class="raid-section">
						<div class="raid-type-name fc-normal-03-m">
							<div class="raid-type">
								<spring:message code="label.cg180203.card_raid_type_d"></spring:message>
							</div>
							<div class="raid-require-level">
								<span><img class="arrow-img"
									src="<p:localurl value='/resources/images/Arrow02.png' />" /></span>
						...
						<div>
							...
							<div class="raid-btn-action">
								<img
									...
									href="<p:fullurl value='/cg1803/cg180303/index/D' />" />
							</div>
							<div class="raid-clear-count clear-count">
								<spring:message code="label.cg180202.clear_count"></spring:message>
								${clearCountD}
