		...
		<div>
			<div class="panel-header panel-header-padding">
				<div class="item-name-style">
					<span>${reward.card.name}</span>
				</div>
				<div class="item-stars-style">
					<div class="card-star">
						<c:forEach begin="1" step="1" end="${reward.card.star}" var="idx">
				...
				<div class="card-assistant">
					<div class="small-card-width">
						<div class="card-assistant-image">
							<img alt="" src='<p:cardImg type="small" id="${reward.card.id}"></p:cardImg>'>
						</div>
					</div>
