...
<div class="content">
	...
	<div class="info">
		<c:if test="${not empty gamePlayerList }">
			<c:if test="${not empty gamePlayer}">
				<div class="my-rank"><spring:message code="label.cg230101.myrank" />${ gamePlayer.ranking}<spring:message code="label.cg230101.ranking" /></div>
			</c:if>
