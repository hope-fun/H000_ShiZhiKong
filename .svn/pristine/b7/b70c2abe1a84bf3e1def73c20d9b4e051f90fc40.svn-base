...
@property (nonatomic, strong) NSString *cooOrderSerial;				/**< 合作商的订单号，必须保证唯一，双方对账的唯一标记（用GUID生成，32位）*/
...
@property (nonatomic, strong) NSString *payDescription;				/**< 购买描述，可选，没有为空 */
...
@property (nonatomic, strong) NSString *cooOrderSerial;		/**< 购买订单号 */
@property (nonatomic, strong) NSString *buyTime;			/**< 购买时间（yyyy-MM-dd HH:mm:ss) */
...
@property (nonatomic, strong) NSString *appName;			/**< 应用软件名称 */
...
@property (nonatomic, strong) NSString	*cooOrderSerial;			/**< 充值订单号（默认为空）*/
@property (nonatomic, strong) NSString	*rechargingTime;			/**< 充值时间（yyyy－MM－dd HH：mm：ss）*/
@property (nonatomic, strong) NSString	*rechargingType;			/**< 充值渠道 */
