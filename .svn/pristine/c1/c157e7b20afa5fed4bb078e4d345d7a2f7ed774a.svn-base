...
<div class="content">
	...
	<div class="continueButton">
			<img class="clickTone1" src='<p:localurl value="/resources/images/buttons/chongxintiaozhan-green-z.png"/>'  onclick="location.href='<p:fullurl value="/cg1803/cg180302/index/"/>';event.preventDefault();"/>
	</div>
