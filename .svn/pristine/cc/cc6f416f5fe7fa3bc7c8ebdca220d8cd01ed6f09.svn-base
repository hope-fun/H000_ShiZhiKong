...
<div class="content">
	...
	<div class="tab-view">
		...
		<div class="clickTone1" onclick="window.location.href='<p:fullurl value='/cg1601/cg160104/index'/>'">
			<img width="100%" height="100%" src="<p:localurl value="/resources/images/buttons/wuzijiangli-yellow-b.png"/>" />
		</div>
		<div></div>
	</div>
					...
					<div style="width: 100%;text-align: center;">
						...
						<div class="fc-container-01">
							...
							<c:if test="${empty item.isGrant}">
								<img class="" src='<p:localurl value="/resources/images/buttons/wancheng.png"/>' />
							</c:if>
						</div>
						<div class="clearfix"></div>
							</div>
