...
$(function(){	
	$(".day1").each(function(){
		...
		if(rewardCondition==20) $(this).removeClass("eachlist2").addClass("eachlistTotal1");
...
<div class="content">
	...
	<div class="camp-adv">
		<img
			src='<p:localurl value="/resources/images/xuanchuan/huodongbanner03.png"/>'>
	</div>
				...
				<div class="cg210101-info02">
					...
					<div class="borderPanel">
						...
						<div class="cg210101-activity-content">
							<span><spring:message code="label.cg210105.adv.time.content"></spring:message></span>
						</div>
					</div>
					<div class="cg210101-info-title">
						<img class="clickTone1"
