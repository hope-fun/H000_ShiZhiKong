...
<div class="content">
	<div class=" menu-medium title-label-03">
		<span class="label-title-attack"><spring:message code="label.CG020104.chaptertitle"></spring:message></span>
	</div>
	<div>
		<img alt="" src="<p:localurl value='/resources/images/xuanchuan/cg020104NextChapter.png' />">
	</div>
	<div class="next-chapter-style">
		<div class="borderPanel">
			...
			<div class="border-content">
				...
				<div>
					<spring:message code="label.CG020104.chaptercomplete"></spring:message>
				</div>
			</div>
		</div>
	</div>
