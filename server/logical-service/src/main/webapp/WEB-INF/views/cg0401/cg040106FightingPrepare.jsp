...
<input type="hidden" id="playerTaskSectionId" value="${playerTaskSectionId}"/>
<div  class="content cg040106">
	...
	<c:if test="${not empty playerTaskSectionId}">
		<input id="dofightUrl" type="hidden" value="<p:fullurl value="/cg0401/cg040106/fightFromPve/"/>" />
	</c:if>		
	<c:if test="${empty playerTaskSectionId}">
		 <c:choose>		
			<c:when test="${not empty treasureFragmentId}">
				<input id="dofightUrl" type="hidden" value="<p:fullurl value="/cg0401/cg040106/fight/${treasureFragmentId}/"/>" />
			</c:when>	
			<c:otherwise>
				<input id="dofightUrl" type="hidden" value="<p:fullurl value="/cg0401/cg040106/fight/"/>" />
			</c:otherwise>	
		</c:choose>	
	</c:if>			
			
		
	<input id="changeGroupUrl" type="hidden" value="<p:fullurl value="/cg0401/cg040106/changePlayerCardGroup/"/>" />
	<input id="useDiamond" type="hidden" value="<p:fullurl value="/cg0401/cg040106/useDiamond/"/>" />
	<div style="display:none">
		<img class="jqPopupcg040102action clickTone1"
			src="<p:localurl value="/resources/images/buttons/buchongnengliang-blue.png"/>">
		<img class="jqPopupcg040102cancel clickTone1"
			src="<p:localurl value="/resources/images/buttons/jixugongji-green.png"/>">
		<img class="jqPopupcg040102fangqi clickTone1"
			src="<p:localurl value="/resources/images/buttons/quxiao-blue.png"/>">
		<img class="jqPopupcg040102fanji clickTone1"
		...
		<div class="borderPanel">
					...
					<div class="border-content-noleft">
						<div class="totalPower">
							<div class="all-power-info"><div class="now-power"><spring:message code="label.cg040106.totalattackpower"></spring:message></div><div class="total-power">${totalAttackPower }</div></div>
							<div class="all-power-info02"><div class="now-power"><spring:message code="label.cg040106.totaldefencepower"></spring:message></div><div class="total-power">${totalDefensePower }</div></div>
						</div>
						<div class="consumer-list-image"></div>
						<div class="clearfix"></div>
						<div class="totalPower">
						
						<div class="all-power-info"><div class="add-power"><spring:message code="label.cg040106.attackpoweradd"></spring:message></div><div class="add-power-percent"><span>+ ${extraPowerViewData.fightPowerAddtionPercent }%</span></div></div>
						<div class="all-power-info02"><div class="add-power"><spring:message code="label.cg040106.defencepoweradd"></spring:message></div><div class="add-power-percent"><span>+ ${extraPowerViewData.fightDefencePowerAddtionPercent }%</span></div></div>
						
						</div>
						
						<div class="addedByPower">
							<div class="added-power-count"><div class="added-num-style"><spring:message code="label.cg040106.attack.power"></spring:message> +  ${extraPowerViewData.attackAddedByPower }</div></div>
							<div class="added-power-count02"><div class="added-num-style02"><spring:message code="label.cg040106.defence.power"></spring:message> +  ${extraPowerViewData.defenceAddedByPower }</div></div>
						</div>
						<div class="clearfix"></div>
						
						
						<div class="totalPower">
						<div class="all-power-info"><div class="add-power"><spring:message code="label.cg040106.continue.login"></spring:message></div><div class="add-power-percent"><span>+ ${extraPowerViewData.continueRegisterPercent}%</span></div></div>
						<div class="all-power-info02"></div>
						
						</div>
						<div class="clearfix"></div>
						<div class="addedByPower">
							<div class="all-power-info"><div class="added-num-style"><spring:message code="label.cg040106.attack.power"></spring:message> +  ${extraPowerViewData.attackAddedByRegister }</div></div>
							<div class="all-power-info02"><div class="added-num-style02"><spring:message code="label.cg040106.defence.power"></spring:message> +  ${extraPowerViewData.defenceAddedByRegister }</div></div>
