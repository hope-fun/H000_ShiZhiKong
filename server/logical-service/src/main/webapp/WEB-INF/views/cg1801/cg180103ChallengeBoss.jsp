...
<script>
	function changeCardGroup(form, raidId) {
		...
		form.action = '<p:fullurl value="/cg1801/cg180103/updateCardGroup"/>'
				+ '/' + raidId + '/' + selectId;
		form.submit();
	}
																		...
																		if ((idx + 1) >= len) {
																			if (viewdata.result
																				...
																				if (viewdata.data.fightResult == "FAILURE") {
																					window.location.href = '<p:fullurl value="/cg1801/cg180105/index/"/>'
																							+ viewdata.data.jumpUrlParameter;
																				} else if (viewdata.data.fightResult == "WIN") {
																					window.location.href = '<p:fullurl value="/cg1801/cg180104/index/"/>'
																							+ viewdata.data.jumpUrlParameter;
																				}																			
																				//talking data	
																				var bossId="${raid.description}"+"${raid.name}";																					
...
<div class="content">
	...
	<div class="executeMission">
		...
		<div class="contentOper">
		 <img src='<p:localurl value="/resources/images/boss/${bossViewData.bossId}.png"/>' />
	...
	<form id="attackForm"
		action="<p:fullurl value="/cg1801/cg180103/fight/" />">
