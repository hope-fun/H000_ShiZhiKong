...
<div class="content">
			...
			<div class="border-content-noleft">
				<div class="commonPading01">
					...
					<div class="npc-message-cg2001-new">
						<spring:message code="label.cg200125.npc.info"></spring:message>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="pro-bars clearfix">
		<div>
			...
			<div>
				<div class="processing-bar-blue fc-normal-01-m" processbar="97"></div>
		...
		<div>
			...
			<div>
				<div class="processing-bar-green fc-normal-02-m" processbar="30"></div>
				<div class="pro-bar-num clearfix">
		...
		<div>
			...
			<div>
				<div class="processing-bar-yellow fc-normal-06-m" processbar="75"></div>

			</div>
		</div>
	</div>
	<div class="clear-fix"></div>
	<div class="info-pic03">
		<div>
			<div>
				<img class="tinysmall-card-width"
		...
		<div>
			<div>
				<img
					src='<p:localurl value="/resources/images/middle-equipment.png"/>' />
			</div>
		</div>
		<div>
			<div>
	...
	<div class="conference-buttons commonPadding01">
		<img class="clickTone1"
			onclick="$animation.executeMission('.executeMission',function(){location.href='<p:fullurl value="/cg2001/cg200126/index"/>';event.preventDefault();})"
