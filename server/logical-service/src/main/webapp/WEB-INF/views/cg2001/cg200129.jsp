...
<div class="content">
	...
	<div class="center-site">
		...
		<div class="fc-normal-05-m commonPading01 commonPadding-botton">
			<span><spring:message
					code="label.cg2001.newcommer.challenge.step11"></spring:message></span>
		</div>

	</div>

	<div class=" menu-medium title-label-03">
		<span><spring:message code="label.cg200129.title"></spring:message></span>
	</div>
			...
			<div class="border-content-noleft">
				<div class="commonPading01">
					...
					<div class="npc-message-cg2001-new">
						<span><spring:message code="label.cg200129.npc.info"></spring:message></span>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="advertise-activity">
		<img
			src='<p:localurl value="/resources/images/xuanchuan/cg020111Upgrade.png"/>'>
	</div>


	<div class="commonPading02 center-site">
		<img class="clickTone1"
			onclick="location.href='<p:fullurl value="/cg2001/cg200130/index"/>';event.preventDefault();"
