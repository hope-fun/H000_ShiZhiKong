...
<script type="text/javascript">
	function getTotalChargeReward(obj) {
		var $a = $(obj);
		$a.attr("onclick", "");

		var options = {
			url : "<p:fullurl value='/cg2101/cg210106/getTotalChargeReward' />",
			data : {
				id : $(obj).attr("id"),
				type : $(obj).attr("type")
			},
			...
			success : function(json) {
				...
				if (json.succeed == "true") {
					...
					updatePlayerInfo();
					var st = "<p:fullurl value='"+ "/cg2101/cg210106/index'/>";
					if(json.uniqueCard=="true") kpyxTips(
							"<spring:message code='label.cg01010301.draw.success'/>"+'<br><div style="padding:10px 50px 0px 80px"><spring:message code="label.cg210106.reward.unique.card"/></div>',
							function() {
...
<div class="content">
	...
	<div class="camp-adv">
		<img
			src='<p:localurl value="/resources/images/xuanchuan/huodongbanner06.png"/>'>
	</div>
	...
	<div class="notice-info">
		...
		<div class="borderPanel">
			...
			<div class="panelA-body panelActivityButton-height1"></div>
				...
				<div class="cg210101-info02">
					...
					<div class="borderPanel">
						...
						<div class="cg210101-activity-content2">
							<span><spring:message
									code="label.cg210106.adv.content"></spring:message></span>
						</div>
					</div>
					
					<div class="cg210101-info-title">
						<img class="clickTone1"
							src='<p:localurl value="/resources/images/activityreward/leijichongzhi.PNG"/>'>
					</div>
					<div style="float: left;margin-top: -48px;margin-left: 150px;"><span>${totalNum}钻石</span></div>
				</div>
				...
				<div class="conference-buttons">
					<c:choose>
						<c:when test="${rewardAble eq 'true' }">
							...
							<img class="clickTone1" onclick="getTotalChargeReward(this)"
			...
			<div class="borderPanel">
				...
				<div class="panelA-body " style="height: 1000px;">
					<div class="reward-info1" id="rewardBody">
						...
						<img 
							src='<p:localurl value="/resources/images/activityreward/leichong${item1.preCondition}.png"/>'>
					</div>
					<div class="clearfix"></div>
							<div style="height:180px" >

								<div class="eachlist1" id="rewardCondition_${item1.preCondition}">

								<c:forEach items="${item1.activityRewards}" var="item">
									<cards:2101_showAllRewardsfew item="${item}" distance="50" />
								...
								<div id="hasGet_${item1.preCondition}" class="alreadyGetAndLose"
									style="left: -5px;"></div>
							</div>
						</c:forEach>
					</div>
