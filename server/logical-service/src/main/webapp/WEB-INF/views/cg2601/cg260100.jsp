...
<script>
	$(function(){
		...
		$(".use_btn").click(function(){
			window.location.href = "<p:fullurl value="/cg2601/cg260100/use" />";
		});
...
<!--  -->
								...
								<div>
									...
									<div class="buy-button-height">
										<c:choose>
											...
											<c:otherwise>
												<a href="<p:fullurl value='/cg2601/cg260100/use/D1' />"><input type="image" class="use_button"src="<p:localurl value="/resources/images/buttons/shiyong-green.png"/>"></a>
											</c:otherwise>
										</c:choose>
									</div>
								</div>
								...
								<div>
									...
									<div class="buy-button-height">
										<c:choose>
											...
											<c:otherwise>
												<a href="<p:fullurl value='/cg2601/cg260100/use/D2' />"><input type="image" class="use_button clickTone1" src="<p:localurl value="/resources/images/buttons/shiyong-green.png"/>"></a>
											</c:otherwise>
										</c:choose>
									</div>
								</div>
	...
	<div class="buy-vip-style">
		<img class="clickTone1" src='<p:localurl value="/resources/images/buttons/fanhui-green-z.png"/>' onclick="doJump('<p:fullurl value='/cg2601/cg260102/index' />')" />
	</div>
</div>