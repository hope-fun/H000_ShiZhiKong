...
<script>
	function changeCardGroup(form, bossId) {
		var selectId = form.selectCardGroup.options[form.selectCardGroup.selectedIndex].value;
		form.action = '<p:fullurl value="/cg2601/cg260105/updateCardGroup"/>'
				+ '/'+ bossId +'/'+ selectId;
		form.submit();
	}
																		...
																		if ((idx + 1) >= len) {
																			if (viewdata.result
																				...
																				if (viewdata.data.fightResult == "FAILURE") {
																					window.location.href = '<p:fullurl value="/cg2601/cg260107/index"/>'		
																				} else if (viewdata.data.fightResult == "WIN") {
																					window.location.href = '<p:fullurl value="/cg2601/cg260106/index/"/>'
...
<div class="content">
	<div class=" menu-medium title-label-03">
		<span class="label-title-attack"><spring:message
				code="label.cg260105.title"></spring:message></span>
	</div>
	<div class="executeMission">
		...
		<div class="contentOper">
			<img
				src='<p:localurl value="/resources/images/activityboss/${bossViewData.bossId}.png"/>' />
	...
	<form id="attackForm"
		action="<p:fullurl value="/cg2601/cg260105/fight/" />">
		...
		<input type="hidden" id="bossAttack"
			...
			value="<c:out value="${bossViewData.cardGroupTotalAttack}"></c:out>" /> <input 
			type="hidden" id="attackNum" 
			value="<c:out value="${bossViewData.attackNum}"></c:out>" /><input 
			type="hidden" id="bossId" 
			value="<c:out value="${bossViewData.bossId}"></c:out>" />
		...
		<div id="fight" class="attack-button-style" onclick="fightClick(this)">
						...
						<div class="raid-width">
							<form method="get">
								<select id="selectCardGroup" class="selectboxdiv"
									...
									onchange="changeCardGroup(this.form,'<c:out value="${bossViewData.bossId}"></c:out>')">
