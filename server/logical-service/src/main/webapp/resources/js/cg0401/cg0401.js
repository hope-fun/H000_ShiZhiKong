...
//				var doJudgeUrl = $("#doJudgeUrl").val() + enemyId;
				var url = $("#fightactionEnough").val() + "/" + enemyId+ "/false";
				var dofightUrl = $("#dofightUrl").val() + enemyId +"/"+playerCardIds+ "/true";
				
				if(playerTaskSectionId != "")
				{
					dofightUrl = dofightUrl+"/"+playerTaskSectionId;
				}
