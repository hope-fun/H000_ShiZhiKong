...
<input type="hidden" id="sensitive1"
	value="<spring:message code='label.cg01010301.sen1' />" />
<input type="hidden" id="sensitive2"
	value="<spring:message code='label.cg01010301.sen2' />" />
...
<c:if test="${empty header['requestType']}">
	...
	<div class="panelSide">
		...
		<div class="eachButton1">
			<img class="img-reward clickTone1"
	...
	<div class="panel-attackanddefence">
		...
		<div class="totalAttackNum">
			<span class="fc-content-01">${totalAttackAdded}</span>
		</div>
		...
		<div class="totalDefenceNum">
			<span class="fc-content-01">${totalDefenceAdded}</span>
		</div>
	</div>
  </div>
<div class="refresh">
...
<img    onclick="location.href = '<p:fullurl value="/cg2201/cg220107/playerDetail/${bestPlayer.playerId }?urlFrom=cg230101" />';event.preventDefault();"
				src="<p:localurl value="/resources/images/homePage/zuiqiangwanjia.png"/>">
				
</div>
	<div class="bestPlayer-name"><span style="font-size: 18pt">${bestPlayer.playerName}</span></div>
	<div class="bestPlayer-conquest"><span style="font-size: 18pt">${bestPlayer.conquestPoints}</span></div>
	<div class="clearfix"></div>
	<!-- 当请还有未分配的属性点时，更新此段 -->
					...
					<c:choose>
						...
						<c:otherwise>
							<img class="clickTone1"
								...
								<div style="float: left;margin-top:-135px;color: rgb(0, 252, 255);margin-left:240px;font-size: 22pt;"><span>${gamePlayer.ranking }</span></div>
								</c:if>
								<c:if test="${gamePlayer.ranking>10000 }">
									<div style="float: left;margin-top:-135px;color: rgb(0, 252, 255);margin-left:240px;font-size: 18pt;"><%--<span> <spring:message code="label.cg01010301.ranking" /></span> --%></div>
								</c:if>
						</c:otherwise>
					</c:choose>
				</div>
