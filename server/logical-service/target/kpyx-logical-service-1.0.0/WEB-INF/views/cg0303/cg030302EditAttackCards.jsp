...
<div class="content cg030302">
	<div class=" menu-medium title-label-03">
		<span><spring:message code="label.cg030302.title"></spring:message></span>
	</div>
	...
	<div class="second-button">
		...
		<c:if test="${ empty playerCardGroupVO.playerId  }">
			<div class="button-large link-button-02">
				<span><spring:message code="label.cg03030101.panel.tab1"></spring:message></span>
			</div>
		</c:if>
										...
										<div class="button-style-02">
											...
											<div class="single-card-button">
												<img class="btn_card_delete clickTone1"
													...
													onclick='location.href="<p:fullurl value="/cg0303/cg030302/deteleCard/${playerCardGroupVO.id}/${playerCardGroupCard.id }"/>"' />
											</div>
											<div class="clearfix"></div>
										</div>
									</div>
		...
		<c:when test="${canAddCard == true }">
			...
			<div class="select_add_btn">
				<img
					...
					class='clickTone1'
					onclick="location.href='<p:fullurl value="/cg0303/cg030303/index/${select_add_playercardId}"/>'" />
			</div>
		</c:when>
		<c:otherwise>
			<!--  the add more card button -->
