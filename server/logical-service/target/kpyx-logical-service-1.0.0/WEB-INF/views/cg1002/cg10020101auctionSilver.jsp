...
<div class="content">
	...
	<div class="tabpanel">
		<div>
			<img alt=""
				src='<p:localurl value="/resources/images/buttons/chushouzuanshi-blue-b.png"/>' onclick='location.href="<p:fullurl value="/cg1002/cg100201/index"/>";event.preventDefault();' class='clickTone1'/>
		</div>
		<div>
			<img alt=""
				src='<p:localurl value="/resources/images/buttons/chushoushuijng-yellow-b.png"/>' onclick='location.href="<p:fullurl value="/cg1002/cg10020101/index"/>";event.preventDefault();' class='clickTone1'/>
		</div>
		<div></div>
	</div>
	...
	<div>
				...
				<div class="border-content">
					<div class="consumer-list">
						<div class="consumer-list-title">
							<span class="fc-normal-05-m system-content-bold"><spring:message code="label.cg1001.nindangqianyongyoushuijin" /></span><span
								class="all_goldcoin">${playerVO.silverCoin }</span><span><spring:message code="label.cg1001.shuijin" /></span>
						</div>
					</div>
					<div class="consumer-list-image"></div>
					<div class="sale_message">
						<div>
							<span class="fc-normal-05-m system-content-bold"><spring:message code="label.cg1001.chushoujiage" /></span> <input
								type="text" id="salePrice" class="price diamond-price" value="" /> <span><spring:message code="label.cg1001.zuanshi" /></span>
						</div>
						<div>
							<span class="fc-normal-05-m system-content-bold"><spring:message code="label.cg1001.chushoushuliang" /></span> <select
								id="selct_sale_num" class="select-diamond-count"
							...
							</select> <span><spring:message code="label.cg1001.shuijin" /></span>
						</div>
						<div class="sale_num">
							<span><spring:message code="label.cg1001.ninxuanzechushou" /></span><span class="select_num">0</span><span><spring:message code="label.cg1001.geshuijin" /></span>
						</div>
			...
			<div class="borderPanel">
				...
				<div class="border-content">
					<div class="npc-message">
						...
						<div class="npc-info">
							<div>
								<span class="fc-normal-05-m system-content-bold"><spring:message code="label.cg1001.ninquedingyaochushouma" /></span>
							</div>
						</div>
						<div></div>
					</div>
		...
		<div class="backtoauction">
			<a href="<p:fullurl value="/cg1001/cg100101/index"/>">
				<img alt=""
				src='<p:localurl value="/resources/images/buttons/fanhuipaimaihangshouye-green-z.png"/>' onclick='location.href="<p:fullurl value="/cg1001/cg100101/index"/>";event.preventDefault();' class='clickTone1'>
			</a>
		</div>
	</div>
</div>
<script type="text/javascript" charset="utf-8"
	src="<p:fullurl value='/resources/js/cg1002/cg1002.js'/>"></script>