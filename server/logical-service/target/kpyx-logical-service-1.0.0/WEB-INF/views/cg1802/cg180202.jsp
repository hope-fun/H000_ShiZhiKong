				...
				<div class="raid-section">
					...
					<div>
						<div class="raid-require-ticket fc-normal-06-m">
							<spring:message code="label.cg180202.require_ticket_a"></spring:message>
						</div>
						<div class="raid-btn-action">
							<img
								src="<p:localurl value='/resources/images/buttons/zhixing-green.png'/>"
								class="btn-action clickTone1" requireLevel="20" requireKey="5"
			...
			<div class="borderPanel padding-top-style10">
				...
				<div class="border-content-noleft">
					<div class="raid-section">
						...
						<div>
							<div class="raid-require-ticket fc-normal-06-m">
								<spring:message code="label.cg180202.require_ticket_b"></spring:message>
							</div>
							<div class="raid-btn-action">
								<img
									src="<p:localurl value='/resources/images/buttons/zhixing-green.png'/>"
									class="btn-action clickTone1" requireLevel="40" requireKey="10"
			...
			<div class="borderPanel padding-top-style10">
				...
				<div class="border-content-noleft">
					<div class="raid-section">
						...
						<div>
							<div class="raid-require-ticket fc-normal-06-m">
								<spring:message code="label.cg180202.require_ticket_c"></spring:message>
							</div>
							<div class="raid-btn-action">
								<img
									src="<p:localurl value='/resources/images/buttons/zhixing-green.png'/>"
									class="btn-action clickTone1" requireLevel="60" requireKey="15"
			...
			<div class="borderPanel padding-top-style10">
				...
				<div class="border-content-noleft">
					<div class="raid-section">
						...
						<div>
							<div class="raid-require-ticket fc-normal-06-m">
								<spring:message code="label.cg180202.require_ticket_d"></spring:message>
							</div>
							<div class="raid-btn-action">
								<img
									src="<p:localurl value='/resources/images/buttons/zhixing-green.png'/>"
									class="btn-action clickTone1" requireLevel="80" requireKey="30"
