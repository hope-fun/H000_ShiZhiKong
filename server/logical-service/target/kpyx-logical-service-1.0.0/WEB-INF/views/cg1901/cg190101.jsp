	...
	<div class="tab-panelButton">
		<div>
			<div class="tabbutton25">
				<img class="clickTone1" width="100%" height="100%" src="<p:localurl value="/resources/images/buttons/xingjiPVP-yellow-b.png"/>" onclick="location.href='<p:fullurl value="/cg1901/cg190101/index/"/>';event.preventDefault();"/>
			</div>
			<div class="tabbutton25">
		...
		<div class="tip-style">
			<span class="fc-normal-06-m">*<spring:message code="label.cg190101.tip"></spring:message></span>
		</div>
		<div class="panel1901">
			<img class="adv-width" src='<p:localurl value="/resources/images/xuanchuan/cg190101.png"/>'>
		</div>
		<!--  <div class="button-large link-button-main-green" onclick="window.location.href = '<p:fullurl value="/cg1802/cg180201/index" />'">
			<span><spring:message code="label.cg190101.active1"></spring:message></span>
		</div>-->
