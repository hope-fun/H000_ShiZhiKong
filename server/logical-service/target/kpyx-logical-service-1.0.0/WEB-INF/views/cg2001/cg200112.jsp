...
<div class="content">
	<div class="center-site">
		...
		<div class="fc-normal-05-m commonPading01 commonPadding-botton">
			<span><spring:message
					code="label.cg2001.newcommer.challenge.step3"></spring:message></span>
		</div>
	</div>
			...
			<div class="border-content-noleft">
				<div class="commonPading01">
					...
					<div class="npc-message-cg2001-new">
						<spring:message code="label.cg200112.npc.info"></spring:message>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="pro-bars clearfix">
		<div>
			...
			<div>
				<div class="processing-bar-blue fc-normal-01-m" processbar="99"></div>
		...
		<div>
			...
			<div>
				<div class="processing-bar-green fc-normal-02-m" processbar="10"></div>
				<div class="pro-bar-num clearfix">
		...
		<div>
			...
			<div>
				<div class="processing-bar-yellow fc-normal-06-m" processbar="25"></div>
	...
	<div class="conference-buttons commonPadding01">
		<img class="clickTone1"
			onclick="$animation.executeMission('.executeMission',function(){location.href='<p:fullurl value="/cg2001/cg200113/index"/>';event.preventDefault();})"
