...
<link rel="stylesheet" type="text/css"
	...
	function getCardUpgradeReward(obj) {
		var $a = $(obj);
		$a.attr("onclick", "");

		var options = {
			url : "<p:fullurl value='/cg2101/cg210104/getCardUpgradeReward' />",
			data : {
				id : $(obj).attr("id"),
				type : $(obj).attr("type")
			},
			...
			success : function(json) {
				...
				if (json.succeed == "true") {
					...
					updatePlayerInfo();
					var st = "<p:fullurl value='"+ "/cg2101/cg210104/index'/>";
...
<div class="content">
	...
	<div class="camp-adv">
		<img
			src='<p:localurl value="/resources/images/xuanchuan/huodongbanner04.png"/>'>
	</div>
				...
				<div class="cg210101-info02">
					...
					<div class="borderPanel">
						...
						<div class="cg210101-activity-content">
							<span><spring:message
									code="label.cg210105.adv.time.content"></spring:message></span>
						</div>
					</div>
					<div class="cg210101-info-title">
						<img 
					...
					<div class="borderPanel">
						...
						<div class="cg210101-activity-content2">
							<span><spring:message
									code="label.cg210104.adv.content.content"></spring:message></span>
						</div>
					</div>
				</div>
				...
				<div class="conference-buttons">
					<c:choose>
						<c:when test="${isReachedLevel eq 'true' }">
							...
							<img class="clickTone1" onclick="getCardUpgradeReward(this)"
	...
	<div class="panel-01">
		...
		<div style="width: 100%;">
			<div class="borderPanel">
				<div class="panelA-header"></div>
				<div class="panelA-body " style="height: 950px;">
					<div class="reward-info1" id="rewardBody">
						<c:forEach items="${allRewards}" var="item1" varStatus="i">
							<div style="float: left; padding-left: 30px;">
								<img
									src='<p:localurl value="/resources/images/activityreward/kapai${item1.preCondition}.png"/>'>
							</div>
							<div class="clearfix"></div>
							<div style="height: 180px">

								<div class="eachlist-rank" id="rewardCondition_${item1.preCondition}">

									<c:forEach items="${item1.activityRewards}" var="item">
										<cards:2101_showAllRewardsfew item="${item}" distance="43" />
									</c:forEach>
								</div>
