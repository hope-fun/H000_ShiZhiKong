...
$(document).ready(function() {
	...
	<div style="text-align: center;" class="panel-03">
			<img class="clickTone1" src='<p:localurl value="/resources/images/buttons/chouqukabao-blue-z.png"/>' onclick="location.href='<p:fullurl value="/cg0801/cg080102/index"/>';event.preventDefault();"/>
	</div>
	<div style="text-align: center;" class="panel-03">
