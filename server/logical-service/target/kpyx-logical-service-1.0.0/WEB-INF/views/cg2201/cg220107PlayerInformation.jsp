...
<div class="content">
	<div class=" menu-medium title-label-03">
		<span><spring:message code="label.cg050107.playerfriend.title" /></span>
	</div>
	...
	<c:if test="${empty urlFrom }">
		<input type="hidden" id="returnUrl" value="<p:fullurl value="/cg2201/cg220107/index" />" />
	</c:if>
	<c:if test="${urlFrom eq 'cg230101' }">
		<input type="hidden" id="returnUrl" value="<p:fullurl value="/cg2301/cg230101/index" />" />
	</c:if>
	<c:if test="${urlFrom eq 'cg230102' }">
		<input type="hidden" id="returnUrl" value="<p:fullurl value="/cg2301/cg230102/index" />" />
	</c:if>
	<c:if test="${urlFrom eq 'cg230103' }">
		<input type="hidden" id="returnUrl" value="<p:fullurl value="/cg2301/cg230103/index" />" />
	</c:if>
	<div>
	<div class="panel-02">
