...
<script>
	...
	function useConsumable(obj){		
		...
		var cardsCount = eval("${playerVO.cardsCount}");
		var cardsMax = eval("${playerVO.cardsMax}");
			//新手礼包 内均有1张卡牌
		...
		<c:if test="${item.count >0}">
			<div class="paddign-style15">
				<div class="borderPanel">
					...
					<div class="panelB-body panelB03-height panelB03-height-new panelB-height-cg060101"></div>
