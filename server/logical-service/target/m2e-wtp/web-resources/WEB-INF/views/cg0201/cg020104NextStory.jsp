...
<div class="content">
	...
	<div class=" menu-medium title-label-03">
		<span class="label-title-attack"><spring:message code="label.CG020104.storytitle"></spring:message></span>
	</div>
	<div>
		<img alt="" src="<p:localurl value='/resources/images/xuanchuan/cg020104NextStory.png' />">
	</div>
		...
		<div class="borderPanel">
			...
			<div class="border-content">
				<div class="card-assistant npc-padding">
					...
					<div class="description_content" style="text-align: left;">
						<span><spring:message code="label.CG020104.storycomplete"></spring:message></span>
