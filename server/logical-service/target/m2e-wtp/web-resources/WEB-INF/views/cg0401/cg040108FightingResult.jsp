...
$(document).ready(function() {
	...
	<div style="text-align: center;" class="panel-03">
	 ...
	 <c:choose>		
		<c:when test="${not empty playerTaskSectionId}">
				<img class="clickTone1"
						src='<p:localurl value="/resources/images/buttons/fanhui-blue-z.png"/>'
						onclick="location.href='<p:fullurl value="/cg0201/cg020104/index/${playerTaskSectionId}"/>';event.preventDefault();" />
		</c:when>	
		<c:otherwise>
	...
	<div style="text-align: center;" class="panel-03">
		<img class="clickTone1"
			...
			onclick="location.href='<p:fullurl value="/cg0801/cg080102/tabchange/HERO"/>';event.preventDefault();" />
	</div>
	<div style="text-align: center;" class="panel-03">
		<img class="clickTone1"
