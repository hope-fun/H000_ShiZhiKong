...
<div class="content">
	...
	<div class="borderPanel" style="width: 100%; text-align: center;">
		...
		<div class="vip-middle-border" style="height: 950px;"></div>
		...
		<div class="vip-border-content">
				...
				<div class="hasCharge_rate">
					...
					<div class="graph">
						<c:choose>
							...
							<c:otherwise>
								<div class="orange"
									style="width: ${mPoints/nextVip.accumDiamonds*100}%; margin-left: -2px;"></div>
							</c:otherwise>
						</c:choose>
						...
						<div style="height: 118px;">
							<c:if test="${displayPercent>0}">
								...
								<c:if test="${canGetRebate==true}">
									<img
										style="position: relative; float: left; left: ${displayPercent*100-15.1}%;"
			...
			<div
				style="text-align:center;width:100%;height:104px;background:url('<p:fullurl value='/resources/images/vip/zaichongzhidi.png'/>') center bottom no-repeat;background-size:auto 100%;">
			...
			<span><spring:message code='label.cg090107.zaichong'></spring:message><span style="color: red;">${nextRebate.diamondTarget-mPoints}</span><spring:message code='label.cg090107.zuanshiling' /><span style="color: red;">${nextRebate.rebateNum}</span><spring:message code='label.cg1001.zuanshi' /></span>
						</c:otherwise>
					</c:choose>
				</div>
			...
			<span><spring:message code='label.cg090107.zaichong'></spring:message><span style="color: red;">${nextVip.accumDiamonds-mPoints}</span><spring:message code='label.cg090107.zuanshishengji'></spring:message></span>
								...
								<img style="top: 10px;left: -10px;position: relative;"
			...
			<div class="vip-border-content" style="top: 520px;">
				...
				<div class="vip-imgLeft clickTone1">
				...
				<div class="vip_briefIntro">
					<c:forEach items="${vipList}" var="item" varStatus="k">
						<marquee style="display: none;" id="vip_${k.index}"
							...
							<div>
								...
								<div class="vip-left" id="wordsVip_${k.index}">
									...
									<div>
										...
										<div>
											<span class="left-style"><span class="fc-normal-05-m"><spring:message
				...
				<div class="clearfix"></div>
				<div class="vip-imgRight clickTone1">
