...
<div class="content">
	...
	<div class="tab-view">
		<div class="clickTone1" onclick="window.location.href='<p:fullurl value='/cg1601/cg160101/index'/>'">
			<img width="100%" height="100%" src="<p:localurl value="/resources/images/buttons/lichengjiangli-yellow-b.png"/>" />
		</div>
		...
		<div class="clickTone1" onclick="window.location.href='<p:fullurl value='/cg1601/cg160103/index'/>'">
			<img width="100%" height="100%" src="<p:localurl value="/resources/images/buttons/zhanjijangli-blue-b.png"/>" />
		</div>
	...
	<c:forEach items="${resList}" var="item" varStatus="i">
		<div class="panel-01 MileStoneItem">
			<form id="subForm${i.index}" method="POST" action="<p:fullurl value="/cg1601/cg160101/getReward"/>">
				<input type="hidden" name="id" value="${item.id}" /> 
				<input type="hidden" name="milestoneId" value="${item.milestoneId}" /> 
				<input type="hidden" name="name" value="${item.name}" /> 
				<input type="hidden" name="description" value="${item.description}" /> 
				<input type="hidden" name="milestoneType" value="${item.milestoneType}" />
				<input type="hidden" name="milestoneSubType" value="${item.milestoneSubType}" /> 
					...
					<div class="border-content-noleft">
						<div class="propsListStyle">
							<div>
								...
								<div class="fc-title-parent-02">
									<span class="fc-title-02"><spring:message
											code="lable.cg1601.reward.Desc.message"></spring:message>:</span> <span
								...
								<div class="reward-button-style">
									<c:if test="${item.isGrant}">
										<img class="clickTone1"
											onclick="doCG16Submit('subForm${i.index}','<p:fullurl value="/cg1601/cg160101/index" />','<spring:message code="label.cg1601.reward.success1"></spring:message><br/><spring:message code="label.cg1601.reward.success2"></spring:message>','<spring:message code="label.cg1601.reward.failed1"></spring:message><spring:message code="label.cg1601.reward.failed2"></spring:message>',this)"
