...
<div class="content">
	...
	<div class="tab-view">
		...
		<div class="clickTone1" onclick="window.location.href='<p:fullurl value='/cg1601/cg160102/index'/>'">
			<img width="100%" height="100%" src="<p:localurl value="/resources/images/buttons/yingxiongjiangli-yellow-b.png"/>" />
		</div>
		...
		<div class="panel-01 MileStoneItem">
			<form id="subForm${i.index}" method="POST" action="<p:fullurl value="/cg1601/cg160101/getReward"/>">
				...
				<div class="propsListStyle">
					<div>
						<div class="rewardtitle reward-title-style">
							<span> &nbsp;${item.name}&nbsp;</span>
						</div>
						<c:if test="${ not empty item.isGrant}">
