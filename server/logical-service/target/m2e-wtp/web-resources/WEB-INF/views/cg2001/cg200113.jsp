...
<div class="content">
			...
			<div class="border-content-noleft">
				<div class="commonPading01">
					...
					<div class="npc-message-cg2001-new">
						<spring:message code="label.cg200113.npc.info"></spring:message>
					</div>
	...
	<div class="center-site">
		<span class="fc-content-02"><spring:message
			...
			class="fc-content-02">3</span> <span class="fc-normal-05-l">/</span>
	...
	<div class="conference-buttons commonPadding01">
		<img class="clickTone1"
			onclick="location.href='<p:fullurl value="/cg2001/cg200114/index"/>';event.preventDefault();"
