...
<div class="animationHolder animationHolder_cg2001">
	...
	<div class="contentIntensify">
		<div class="topPart">
			<img class="main" src="<p:cardImg type="middle" id="${mainCardVO.id}"></p:cardImg>" />
		</div>
		<div class="upPart">
			<img class="mat" src="<p:cardImg type="ls" id="${materialCardId}"></p:cardImg>" />
		</div>
...
<div class="content finalRes">
	...
	<div class=" menu-medium title-label-03">
		<span><spring:message code="label.cg200116.title"></spring:message></span>
	</div>
			...
			<div class="border-content-noleft">
				<div class="commonPading01">
					...
					<div class="npc-message-cg2001-new">
						<spring:message code="label.cg200116.npc.info"></spring:message>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="commonPading05" style="width: 100%;">
		<div class="system-content-other commonPadding-top06"
			...
			<span class="blue-font"><spring:message
					code="label.cg200116.mercenary.level"></spring:message></span><span>1</span>
		</div>
...
<div class="cardInfo commonPadding-top">
	<div class="borderPanel">
		...
		<div class="border-content-noleft">
			<div class="image-pic center-site">
				<img alt=""
					src='<p:cardImg type="big" id="${mainCardVO.id }"></p:cardImg>'>
			</div>
				...
				<div class="defenseNeeded">
					<div class="row-zhxq">
						<div class="gitem icon icon-physicalstrength move-from-left">
							...
							<span>${mainCardVO.strengthRequire}</span>
						</div>
					</div>
				</div>
				<div class="down-list-image"></div>
				<div class="textDescription  fc-title-02 commonPading03">
					<span>${mainCardVO.getDescription()}</span>
				</div>
	...
	<div class="conference-buttons commonPadding01">
		<img class="clickTone1"
			onclick="location.href='<p:fullurl value="/cg2001/cg200117/index/${mainCardVO.id}/${nowattack}/${nowdefence}/${nowLevel}/${growingPercent}"/>';event.preventDefault();"
